...
export default function Home() {
  ...
  <header id="header" className="menu-container">
    ...
    <nav id="nav-bar">
      ...
      <ul className="menu">
        ...
        <Link className="highlight" href="/dashboard">
          Getting Started
        </Link>
      </ul>
    </nav>
  ...
  <main className="container">
    <section className="hero container">
      <h1 className="hero-title-primary">Welcome To Taskyfier</h1>
      <p className="hero-title-sub">
      Stay organized and productive with our task manager app. Easily create, prioritize, and track tasks, set deadlines, and never miss a goal again. Try it today!
      </p>
      <Link href={"/dashboard"}>
    ...
    <div className="hero-image">
      <figure>
        ...
        >
          ...
          />
          <path
            d="M446.531 291.236C439.11 280.434 429.344 272.575 416.67 269.28"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
          />
          <path
            d="M442.078 372.341C443.445 378.201 446.25 389.171 449.055 399.585"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
          ...
          />
          <path
            d="M448.514 292.577C444.042 289.292 439.523 287.681 435.229 288.68"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
          ...
          />
          <path
            d="M416.67 247.819V284.218C416.67 287.166 408.75 288.986 400.595 289.241"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
          ...
          />
          <path
            d="M450.881 131.065L433.327 113.485V148.645L450.881 131.065Z"
            fill="black"
          />
          <path
          ...
          />
          <path
            d="M377.4 216.75C377.4 219.3 376.89 227.46 373.83 229.5"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
          />
          <path
            d="M375.615 243.015C380.715 243.015 385.305 239.955 385.305 237.915"
            stroke="black"
            strokeWidth="2.5"
            strokeMiterlimit={10}
            strokeLinecap="round"
  ...
  <section className="video-content">
    <div className="video-story">
      <h1 className="video-title">See in Action</h1>
      <p className="video-subtitle">Story of Theodore</p>
  ...
  <section className="content">
    <div className="inner-content">
      <div className="inner-content-text content__TextLeft">
        ...
        Stay Organized with Your Ultimate Task Manager
        </div>
        <div className="inner-content-para">
          <p>
          Our task manager app is your go-to solution for staying organized and boosting productivity. Whether you're managing work projects, planning your daily to-do list, or keeping track of personal goals, our app provides all the tools you need. Create and categorize tasks, set priorities, and track your progress effortlessly with a clean, user-friendly interface. Customize deadlines and receive reminders to ensure nothing slips through the cracks. 
          </p>
        </div>
      </div>
    ...
    <div className="inner-content">
      <div className="inner-content-text content__TextRight">
        ...
        <div className="inner-content-title">
          Key Features for Efficient Task Management
        </div>
        <div className="inner-content-para">
          <p>
          Our task manager app offers essential features to streamline your workflow. Easily create tasks, set deadlines, and categorize them for better organization. Prioritize tasks with simple priority separation and track progress with clear labels for completed and incomplete tasks. With intuitive task management, reminders, and customization options, staying on top of your to-do list is effortless.
          </p>
        </div>
      </div>
      <div className="inner-image-container container__ImageLeft">
        <div className="inner-content-image content__ImageLeft">
          <img
            className="section-images"
            src="https://images.unsplash.com/photo-1488751045188-3c55bbf9a3fa?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            style={{ objectPosition: "50% 50%" }}
          />
        </div>
      </div>
    ...
    <div className="flex-container">
      <div className="flex-item">
        <ul className="package">
          <li className="header">Self-hosted</li>
          <li className="gray">
            <sup className="dolla">$</sup>0<br />
            <span className="month">
              Per Month
              <span />
            </span>
          </li>
          <li className="features first-feat">Unlimited Updates</li>
          <li className="features">100GB Storage</li>
          <li className="features">Limited API Quota</li>
          <li className="features last-feat">Limited Support</li>
          <li>
      ...
      <div className="flex-item">
        <ul className="package">
          ...
          <li className="features first-feat">Unlimited Updates</li>
          <li className="features">100TB Storage</li>
          <li className="features">Unlimited API Usage</li>
          <li className="features">Advance Support</li>
          <li>
      ...
      <div className="flex-item">
        <ul className="package">
          ...
          <li className="features first-feat">Priority Updates</li>
          <li className="features">Unlimited Storage</li>
          <li className="features">Team Features</li>
          <li className="features">Priority Support</li>
          <li>
  ...
  <section className="subscribe-container">
    ...
    <div className="Links">
      <div className="Link-Div">
        <a href="https://x.com/BansodeBha11285" target="_blank">
        <img src="./twitter.svg" alt="TWITTER" height={50} width={50}/>
        </a>
        <a href="https://www.linkedin.com/in/bhagesh-bansode-011770293/" target="_blank">
        <img src="./linkedin.svg" alt="LINKEDIN" height={50} width={50}/>
        </a>
        <a href="https://leetcode.com/u/BHAGESHBANSODE/" target="_blank">
        <img src="./leetcode.svg" alt="LEETCODE" height={50} width={50}/>
        </a>
        <a href="https://github.com/bhagesh01" target="_blank">
        <img src="./github.svg" alt="GITHUB" height={50} width={50}/>
        </a>
      </div>
    </div>
  </section>
